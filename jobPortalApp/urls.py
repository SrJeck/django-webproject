...
urlpatterns += [
    ...
    path('manage_user/activate_user',
         views.admin_activate_user, name="admin_activate_user"),
    path('manage_user/deactivate_user',
         views.admin_deactivate_user, name="admin_deactivate_user"),
    path('company/', views.company, name="company"),
    path('company/edit_company', views.admin_edit_company,
         name="admin_edit_company"),
    path('company/activate_company', views.admin_deactivate_company,
         name="admin_deactivate_company"),
    path('company/deactivate_company', views.admin_activate_company,
         name="admin_activate_company"),
    path('jobs/', views.jobs, name="jobs"),
    path('jobs/edit_job', views.admin_edit_jobs, name="admin_edit_jobs"),
    path('jobs/activate_job', views.admin_activate_jobs,
         name="admin_activate_jobs"),
    path('jobs/deactivate_job', views.admin_deactivate_jobs,
         name="admin_deactivate_jobs"),
    path('activity_logs/', views.activity_logs, name="activity_logs"),
    path('admin-edit-user/', views.admin_edit_user, name="admin-edit-user"),
    path('admin-edit-company/', views.admin_edit_company,
         name="admin-edit-company"),
    path('admin-edit-job/', views.admin_edit_job,
         name="admin-edit-job"),
]
# lowell
